...
app.use(
  cors({
    origin: ["http://localhost:4173", "http://localhost:5173",'http://localhost:3000','http://localhost:30007','http://localhost:30002'], // Allows only frontend running on localhost:5173
