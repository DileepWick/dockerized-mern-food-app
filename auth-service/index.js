...
app.use(
  cors({
    origin: ["http://localhost:4173","http://localhost:3001","http://localhost:30001","http://localhost:30080"], // Allows only frontend running on localhost:5173 and localhost:4173
