...
app.use(
  cors({
    origin: ["http://localhost:4173","http://localhost:3001","http://localhost:8001","http://localhost:8002"], // Allows only frontend running on localhost:5173 and localhost:4173
